...
document.getElementById('reviewButton').onclick=function(){
    ...
    document.getElementById("reviewPage").innerHTML+=`
            ...
            <div class="firstRowReview">
                <div class="">
                    <figure id="1">
                        <img src="Gamechangers/${allGameChangers[quizImages[0]].surname}.jpeg">
                        <figcaption>
                ...
                <div class="">
                    <figure id="2">
                        <img src="Gamechangers/${allGameChangers[quizImages[1]].surname}.jpeg">
                        <figcaption>
            ...
            <div class="secondRowReview">
                <div class="">
                    <figure id="3">
                        <img src="Gamechangers/${allGameChangers[quizImages[2]].surname}.jpeg">
                        <figcaption>
                ...
                <div class="">
                    <figure id="4">
                        <img src="Gamechangers/${allGameChangers[quizImages[3]].surname}.jpeg">
                        <figcaption>
            ...
            <div class="thirdRowReview">
                <div class="">
                    <figure id="5">
                        <img src="Gamechangers/${allGameChangers[quizImages[4]].surname}.jpeg">
                        <figcaption>
